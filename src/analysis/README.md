...
#### 6. **`analyze_stelle.py`**
   - **Description**: This script is used to analyze the static properties of **full star polymer** systems. 
   - **Functions**:
     - Generates files containing the static properties of the systems
   - **Output**: The analyzed files will be saved in the `data/02_processed/stelle/` directory.
   - **Usage**: Use this script to analyze the static properties star polymer systems.

#### 7. **`visualize_stelle.py`**
   - **Description**: This script is used to visualize the static properties of **full star polymer** systems generated by `analyze_stelle.py`. 
   - **Functions**:
     - Generates plots of the static properties of the systems
   - **Output**: The figures will be saved in the `data/03_analyzed/stelle/` directory.
   - **Usage**: Compute the static properties with `analyze_stelle.py`, then use this script to visualize them.
