...
#### 3. **`msd_pass_calculator.py`**
   - **Description**: This script calculates and plots the **mean squared displacement (MSD)** for passive particles (not the stars).
   - **Functions**:
     - Computes MSD for the free passive particles of the system.
     - Generates plots that show the diffusion characteristics of the passive particles.
   - **Output**: The MSD results and plots will be saved in the `data/03_analyzed/msd/` directory.
   - **Usage**: This script is used for analyzing passive particle data from simulations of full star polymer systems.

#### 4. **`msd_angle_calculator.py`**
...
#### 7. **`voronoi_contact.py`**
   - **Description**: This script is used to create movies of the Voronoi tessellation for **full star polymer** systems. It further visualizes the interaction properties of the system on the screen.
   - **Functions**:
     - Generates a video representation of the star polymer simulation, with the Voronoi tessellation overlaid on top.
   - **Output**: The video files will be saved in the `data/03_analyzed/voronoi/` directory.
   - **Usage**: Use this script to visualize the interaction properties of star polymer systems.

#### 8. **`convex_hulls.py`**
   - **Description**: This script is used to create movies of the convex hulls for **full star polymer** systems. It further visualizes the intersection ratio on screen.
   - **Functions**:
     - Generates a video representation of the star polymer simulation, with the convex hulls overlaid on top.
   - **Output**: The video files will be saved in the `data/03_analyzed/hulls/` directory.
   - **Usage**: Use this script to visualize the convex hulls of star polymer systems and their intersection.

#### 9. **`analyze_stelle.py`**
   - **Description**: This script is used to analyze the static, dynamical and interaction properties of **full star polymer** systems. 
   - **Functions**:
...
#### 10. **`visualize_stelle.py`**
   - **Description**: This script is used to visualize the static, dynamical and interaction properties of **full star polymer** systems generated by `analyze_stelle.py`. 
   - **Functions**:
