...
Dpass=(0.005 0.010 0.015 0.020)
gpass=(30 100 150 200)
...
name=mar_n"$n"_f"$f"_rc"$rc"_rb1.13_rcb0.57_pe2.3_rf10.0_Dt0.010_Dr0.800_gm100_dp"$pas"_rp0.333_Dp"$Dpas"_gp"$gpas""$suffix"; #_mols"$mols"_ri"$ri"
